...
$main:
  ...
  mov byte [r8], byte 0x11;

  push word 10;
  call $malloc;
  mov r9, rax;

  mov byte [r9], byte 0x22;

  push word 10;
  call $malloc;
  mov r10, rax;

  mov byte [r10], byte 0x33;

  push word 10;
  call $malloc;
  mov r11, rax;

  mov byte [r11], byte 0x44;
  ...
  mov byte [r12], byte 0x55;

  push word 10;
  call $malloc;
  mov r13, rax;

  mov byte [r13], byte 0x66;

  push word 10;
  call $malloc;
  mov r14, rax;

  mov byte [r14], byte 0x77;

  push word 10;
  call $malloc;
  mov r15, rax;

  mov byte [r15], byte 0x88;
